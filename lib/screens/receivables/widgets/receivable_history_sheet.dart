...
Future<void> showReceivableHistorySheet(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (context) {
      return SafeArea(
        top: false,
        child: _ReceivableHistorySheet(receivable: receivable),
      );
    },
  );
}

class _ReceivableHistorySheet extends StatelessWidget {
  final Receivable receivable;

  const _ReceivableHistorySheet({required this.receivable});

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
    final settlements = receivable.settlements.reversed.toList();
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${receivable.fromPerson} · Remaining ${AppFormatters.formatCurrency(receivable.remainingAmount)}',
...
class _SettlementRow extends StatelessWidget {
  final ReceivableSettlement entry;
